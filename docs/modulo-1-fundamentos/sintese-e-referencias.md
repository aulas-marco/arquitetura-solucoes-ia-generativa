...
Se mais de duas respostas forem “ainda não”, retome os [temas do módulo](index.md), o [mapa de responsabilidades](responsabilidade-e-efeito.md#mapa-de-responsabilidades), o [exemplo Horizonte](exemplo-arquitetural.md) e os exercícios 8, 11 e 13.
